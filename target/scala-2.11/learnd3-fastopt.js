...
/** @constructor */
function $c_Lfr_iscpif_scaladget_api_BootstrapTags$() {
  $c_O.call(this);
  this.nav$unddefault$1 = null;
  this.nav$undinverse$1 = null;
  this.nav$undstaticTop$1 = null;
  this.nav$undpills$1 = null;
  this.navbar$1 = null;
  this.navbar$undform$1 = null;
  this.navbar$undright$1 = null;
  this.navbar$undleft$1 = null;
  this.dropdown$1 = null;
  this.label$unddefault$1 = null;
  this.label$undprimary$1 = null;
  this.label$undsuccess$1 = null;
  this.label$undinfo$1 = null;
  this.label$undwarning$1 = null;
  this.label$unddanger$1 = null;
  this.black$undlabel$1 = null;
  this.glyph$undedit$1 = null;
  this.glyph$undtrash$1 = null;
  this.glyph$undplus$1 = null;
  this.glyph$undplus$undsign$1 = null;
  this.glyph$undminus$undsign$1 = null;
  this.glyph$undminus$1 = null;
  this.glyph$undok$1 = null;
  this.glyph$undquestion$1 = null;
  this.glyph$undfile$1 = null;
  this.glyph$undfolder$undclose$1 = null;
  this.glyph$undhome$1 = null;
  this.glyph$undupload$1 = null;
  this.glyph$unddownload$1 = null;
  this.glyph$unddownload$undalt$1 = null;
  this.glyph$undsettings$1 = null;
  this.glyph$undoff$1 = null;
  this.glyph$undflash$1 = null;
  this.glyph$undflag$1 = null;
  this.glyph$undremove$1 = null;
  this.glyph$undroad$1 = null;
  this.glyph$undfire$1 = null;
  this.glyph$undlist$1 = null;
  this.glyph$undstats$1 = null;
  this.glyph$undrefresh$1 = null;
  this.glyph$undlock$1 = null;
  this.glyph$undarchive$1 = null;
  this.glyph$undmarket$1 = null;
  this.glyph$undinfo$1 = null;
  this.glyph$undplug$1 = null;
  this.glyph$undexclamation$1 = null;
  this.glyph$undcomment$1 = null;
  this.btn$unddefault$1 = null;
  this.btn$undprimary$1 = null;
  this.btn$undsuccess$1 = null;
  this.btn$undinfo$1 = null;
  this.btn$undwarning$1 = null;
  this.btn$unddanger$1 = null;
  this.btn$undlarge$1 = null;
  this.btn$undmedium$1 = null;
  this.btn$undsmall$1 = null;
  this.btn$undtest$1 = null;
  this.btn$undright$1 = null;
  this.btn$undgroup$undlarge$1 = null;
  this.btn$undgroup$undmedium$1 = null;
  this.btn$undgroup$undsmall$1 = null;
  this.bordered$1 = null;
  this.striped$1 = null;
  this.active$1 = null;
  this.success$1 = null;
  this.danger$1 = null;
  ...
  this.info$1 = null;
  this.nothing$1 = null;
  this.large$undform$undgroup$1 = null;
  this.small$undform$undgroup$1 = null;
  this.form$undinline$1 = null;
  this.input$undgroup$undlg$1 = null;
  this.row$1 = null;
  this.col$undmd$und1$1 = null;
  this.col$undmd$und2$1 = null;
  this.col$undmd$und3$1 = null;
  this.col$undmd$und4$1 = null;
  this.col$undmd$und5$1 = null;
  this.col$undmd$und6$1 = null;
  this.col$undmd$und7$1 = null;
  this.col$undmd$und8$1 = null;
  this.col$undmd$und12$1 = null;
  this.col$undmd$undoffset$und3$1 = null;
  this.col$undmd$undoffset$und2$1 = null;
  this.center$1 = null;
  this.spacer20$1 = null;
  this.alert$undwarning$1 = null
}
$c_Lfr_iscpif_scaladget_api_BootstrapTags$.prototype = new $h_O();
$c_Lfr_iscpif_scaladget_api_BootstrapTags$.prototype.constructor = $c_Lfr_iscpif_scaladget_api_BootstrapTags$;
/** @constructor */
function $h_Lfr_iscpif_scaladget_api_BootstrapTags$() {
  /*<skip>*/
}
$h_Lfr_iscpif_scaladget_api_BootstrapTags$.prototype = $c_Lfr_iscpif_scaladget_api_BootstrapTags$.prototype;
$c_Lfr_iscpif_scaladget_api_BootstrapTags$.prototype.init___ = (function() {
  $n_Lfr_iscpif_scaladget_api_BootstrapTags$ = this;
  this.nav$unddefault$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("navbar-default");
  this.nav$undinverse$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("navbar-inverse");
  this.nav$undstaticTop$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("navbar-static-top");
  this.nav$undpills$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("nav-pills");
  this.navbar$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("navbar-nav");
  this.navbar$undform$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("navbar-form");
  this.navbar$undright$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("navbar-right");
  this.navbar$undleft$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("navbar-left");
  this.dropdown$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("dropdown");
  this.label$unddefault$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("label-default");
  this.label$undprimary$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("label-primary");
  this.label$undsuccess$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("label-success");
  this.label$undinfo$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("label-info");
  this.label$undwarning$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("label-warning");
  this.label$unddanger$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("label-danger");
  this.black$undlabel$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("black-label");
  this.glyph$undedit$1 = "glyphicon-pencil";
  this.glyph$undtrash$1 = "glyphicon-trash";
  this.glyph$undplus$1 = "glyphicon-plus";
  this.glyph$undplus$undsign$1 = "glyphicon-plus-sign";
  this.glyph$undminus$undsign$1 = "glyphicon-minus-sign";
  this.glyph$undminus$1 = "glyphicon-minus";
  this.glyph$undok$1 = "glyphicon-ok";
  this.glyph$undquestion$1 = "glyphicon-question-sign";
  this.glyph$undfile$1 = "glyphicon-file";
  this.glyph$undfolder$undclose$1 = "glyphicon-folder-close";
  this.glyph$undhome$1 = "glyphicon-home";
  this.glyph$undupload$1 = "glyphicon-cloud-upload";
  this.glyph$unddownload$1 = "glyphicon-cloud-download";
  this.glyph$unddownload$undalt$1 = "glyphicon-download-alt";
  this.glyph$undsettings$1 = "glyphicon-cog";
  this.glyph$undoff$1 = "glyphicon-off";
  this.glyph$undflash$1 = "glyphicon-flash";
  this.glyph$undflag$1 = "glyphicon-flag";
  this.glyph$undremove$1 = "glyphicon-remove-sign";
  this.glyph$undroad$1 = "glyphicon-road";
  this.glyph$undfire$1 = "glyphicon-fire";
  this.glyph$undlist$1 = "glyphicon-list";
  this.glyph$undstats$1 = "glyphicon-stats";
  this.glyph$undrefresh$1 = "glyphicon-refresh";
  this.glyph$undlock$1 = "glyphicon-lock";
  this.glyph$undarchive$1 = "glyphicon-compressed";
  this.glyph$undmarket$1 = "glyphicon-shopping-cart";
  this.glyph$undinfo$1 = "glyphicon-info-sign";
  this.glyph$undplug$1 = "icon-plug";
  this.glyph$undexclamation$1 = "glyphicon-exclamation-sign";
  this.glyph$undcomment$1 = "glyphicon-comment";
  this.btn$unddefault$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("btn-default");
  this.btn$undprimary$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("btn-primary");
  this.btn$undsuccess$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("btn-success");
  this.btn$undinfo$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("btn-info");
  this.btn$undwarning$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("btn-warning");
  this.btn$unddanger$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("btn-danger");
  this.btn$undlarge$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("btn-lg");
  this.btn$undmedium$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("btn-md");
  this.btn$undsmall$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("btn-sm");
  this.btn$undtest$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("myButton");
  this.btn$undright$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("pull-right");
  this.btn$undgroup$undlarge$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("btn-group-lg");
  this.btn$undgroup$undmedium$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("btn-group-sm");
  this.btn$undgroup$undsmall$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("btn-group-xs");
  this.bordered$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("table table-bordered");
  this.striped$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("table table-striped");
  this.active$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("active");
  this.success$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("success");
  this.danger$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("danger");
  this.warning$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("warning");
  this.info$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("info");
  this.nothing$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("");
  this.large$undform$undgroup$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("form-group-lg");
  this.small$undform$undgroup$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("form-group-sm");
  this.form$undinline$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("form-inline");
  this.input$undgroup$undlg$1 = "input-group-lg";
  this.row$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("row");
  this.col$undmd$und1$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("col-md-1");
  this.col$undmd$und2$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("col-md-2");
  this.col$undmd$und3$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("col-md-3");
  this.col$undmd$und4$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("col-md-4");
  this.col$undmd$und5$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("col-md-5");
  this.col$undmd$und6$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("col-md-6");
  this.col$undmd$und7$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("col-md-7");
  this.col$undmd$und8$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("col-md-8");
  this.col$undmd$und12$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("col-md-12");
  this.col$undmd$undoffset$und3$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("col-md-offset-3");
  this.col$undmd$undoffset$und2$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("col-md-offset-2");
  this.center$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("text-center");
  this.spacer20$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("spacer20");
  this.alert$undwarning$1 = new $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator().init___T("alert-warning");
  return this
});
var $d_Lfr_iscpif_scaladget_api_BootstrapTags$ = new $TypeData().initClass({
  Lfr_iscpif_scaladget_api_BootstrapTags$: 0
}, false, "fr.iscpif.scaladget.api.BootstrapTags$", {
  Lfr_iscpif_scaladget_api_BootstrapTags$: 1,
  O: 1
});
$c_Lfr_iscpif_scaladget_api_BootstrapTags$.prototype.$classData = $d_Lfr_iscpif_scaladget_api_BootstrapTags$;
var $n_Lfr_iscpif_scaladget_api_BootstrapTags$ = (void 0);
function $m_Lfr_iscpif_scaladget_api_BootstrapTags$() {
  if ((!$n_Lfr_iscpif_scaladget_api_BootstrapTags$)) {
    $n_Lfr_iscpif_scaladget_api_BootstrapTags$ = new $c_Lfr_iscpif_scaladget_api_BootstrapTags$().init___()
  };
  return $n_Lfr_iscpif_scaladget_api_BootstrapTags$
}
$e["BootstrapTags"] = $m_Lfr_iscpif_scaladget_api_BootstrapTags$;
/** @constructor */
function $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator() {
  $c_O.call(this);
  this.key$1 = null
}
$c_Lfr_iscpif_scaladget_api_ClassKeyAggregator.prototype = new $h_O();
$c_Lfr_iscpif_scaladget_api_ClassKeyAggregator.prototype.constructor = $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator;
/** @constructor */
function $h_Lfr_iscpif_scaladget_api_ClassKeyAggregator() {
  /*<skip>*/
}
$h_Lfr_iscpif_scaladget_api_ClassKeyAggregator.prototype = $c_Lfr_iscpif_scaladget_api_ClassKeyAggregator.prototype;
$c_Lfr_iscpif_scaladget_api_ClassKeyAggregator.prototype.init___T = (function(key) {
  this.key$1 = key;
  return this
});
var $d_Lfr_iscpif_scaladget_api_ClassKeyAggregator = new $TypeData().initClass({
  Lfr_iscpif_scaladget_api_ClassKeyAggregator: 0
}, false, "fr.iscpif.scaladget.api.ClassKeyAggregator", {
  Lfr_iscpif_scaladget_api_ClassKeyAggregator: 1,
  O: 1
});
$c_Lfr_iscpif_scaladget_api_ClassKeyAggregator.prototype.$classData = $d_Lfr_iscpif_scaladget_api_ClassKeyAggregator;
/** @constructor */
function $c_Ltutorial_webapp_LearnD3$() {
  $c_O.call(this)
}
$c_Ltutorial_webapp_LearnD3$.prototype = new $h_O();
$c_Ltutorial_webapp_LearnD3$.prototype.constructor = $c_Ltutorial_webapp_LearnD3$;
/** @constructor */
function $h_Ltutorial_webapp_LearnD3$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_LearnD3$.prototype = $c_Ltutorial_webapp_LearnD3$.prototype;
$c_Ltutorial_webapp_LearnD3$.prototype.main__Lorg_scalajs_dom_raw_HTMLDivElement__V = (function(div) {
  $g["d3"]["select"]("body")["append"]("p")
});
$c_Ltutorial_webapp_LearnD3$.prototype.$$js$exported$meth$main__Lorg_scalajs_dom_raw_HTMLDivElement__O = (function(div) {
  this.main__Lorg_scalajs_dom_raw_HTMLDivElement__V(div)
});
$c_Ltutorial_webapp_LearnD3$.prototype["main"] = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$main__Lorg_scalajs_dom_raw_HTMLDivElement__O(prep0)
});
var $d_Ltutorial_webapp_LearnD3$ = new $TypeData().initClass({
  Ltutorial_webapp_LearnD3$: 0
}, false, "tutorial.webapp.LearnD3$", {
  Ltutorial_webapp_LearnD3$: 1,
  O: 1
});
$c_Ltutorial_webapp_LearnD3$.prototype.$classData = $d_Ltutorial_webapp_LearnD3$;
var $n_Ltutorial_webapp_LearnD3$ = (void 0);
function $m_Ltutorial_webapp_LearnD3$() {
  if ((!$n_Ltutorial_webapp_LearnD3$)) {
    $n_Ltutorial_webapp_LearnD3$ = new $c_Ltutorial_webapp_LearnD3$().init___()
  };
  return $n_Ltutorial_webapp_LearnD3$
}
$e["tutorial"] = ($e["tutorial"] || {});
$e["tutorial"]["webapp"] = ($e["tutorial"]["webapp"] || {});
$e["tutorial"]["webapp"]["LearnD3"] = $m_Ltutorial_webapp_LearnD3$;
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
  this.data$1 = null
...
//# sourceMappingURL=learnd3-fastopt.js.map
